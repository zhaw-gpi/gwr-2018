...
import ch.zhaw.gpi.gwr.controller.GwrBuildingController;
...
import ch.zhaw.gpi.gwr.controller.GwrDwellingController;
...
public class GebaeudeUndWohnungsRegisterServiceEndpoint {
     ...
     */    
    @Autowired
    private GwrBuildingController gwrBuildingController;
    
    @Autowired
    private GwrDwellingController gwrDwellingController;
    ...
    public AddresseExistenzType adresspruefung(@WebParam(name = "AdresspruefungAnfrage") AdresseType address) {
        ...
        return gwrBuildingController.checkAddressExistence(address);
    }
    ...
    public WohnungenAntwortType wohnungenAnfrage(@WebParam(name = "WohnungenAnfrage") AdresseType address) {
        ...
        // gibt deren Resultat zurück an den SOAP-Client
        return gwrDwellingController.getDwellingsOfBuilding(address);
    }
